...
def setup():
    data_path  = r"C:\Users\HP\Downloads\correlation-master\correlation-master\data\Ice-Cream vs Cold-Drink vs Temperature - Ice Cream Sale vs Temperature data.csv"
